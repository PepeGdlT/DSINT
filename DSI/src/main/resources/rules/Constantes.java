...
//MITO 2
    ...
    public static final String CAPACIDAD_INVISIBILIDAD = "Invisibilidad";
    public static final String CAPACIDAD_GUARDAR_CABEZA_MEDUSA = "Guardar cabeza Medusa";
    public static final String CAPACIDAD_VUELO = "Vuelo";
    public static final String CAPACIDAD_ATRAPAR_PEGASO = "Atrapar Pegaso";
    ...
    public static final String CAPACIDAD_NULA = "Ninguna";			//PARA OBJETOS SIN CAPACIDAD
